...
if ($_POST['btnTBH'])
	...
	if (empty($beasiswa))
		...
		if ($tcc != 0)
			...
			{
			//query
			mysql_query("INSERT INTO mahasiswa_beasiswa(kd, kd_tapel, kd_mhs, kd_beasiswa) VALUES ".
...
if (empty($s))
	...
	if ($count != 0)
		...
		do
			...
			$qx = mysql_query("SELECT mahasiswa_beasiswa.*, mahasiswa_beasiswa.kd AS mbkd, m_bea_siswa.* ".
