...
if ($x2_pengesahan == "true")
	{
	$x2_pengesahan_ket = "<strong>Telah Disahkan.</strong>";
	}
else
	{
...
if ($_POST['btnSMP'])
	...
	$i_penerima = cegah($_POST['penerima']);
	...
	if ($tcc != 0)
		...
		mysql_query("INSERT INTO surat_masuk_disposisi (kd, kd_surat, tgl_selesai, ".
				...
				"penerima, no_agenda, tgl_dijawab) VALUES ".
				"('$x', '$sukd', '$tgl_selesai', ".
				"'$i_isi_yayasan', '$i_isi_lembaga', '$i_diteruskan', '$i_kepada', '$tgl_kembali', ".
				"'$i_penerima', '$i_agenda_no', '$tgl_dijawab')");
		}

	//re-direct
	$ke = "masuk_disposisi_prt.php?sukd=$sukd";
	xloc($ke);
	exit();
	}
...
<td>:
<input type="text" name="penerima" value="'.$x2_penerima.'" size="30">
</td>
</tr>
