...
$qdata = mysqli_query($koneksi, "SELECT m_mahasiswa.*, ".
				...
				"DATE_FORMAT(m_mahasiswa_alumni.tgl_tulis, '%d') AS 2tgl, ".
				"DATE_FORMAT(m_mahasiswa_alumni.tgl_tulis, '%m') AS 2bln, ".
				"DATE_FORMAT(m_mahasiswa_alumni.tgl_tulis, '%Y') AS 2thn, ".
...
do
	...
	$no_ijazah = balikin($rdata['no_ijazah']);
