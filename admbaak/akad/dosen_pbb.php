...
if ($_POST['btnHPS'])
	...
	for ($i=1; $i<=$jml;$i++)
		...
		//NULL-kan ruang e....
		mysql_query("DELETE FROM dosen_pembimbing ".
				"WHERE kd = '$kdix'");
...
if ($_POST['btnSMPx'])
	...
	//cek, sudah ada ..?
	$qc = mysql_query("SELECT * FROM dosen_pembimbing ".
	...
	if ($tc != 0)
		...
		{
		//query
		mysql_query("INSERT INTO dosen_pembimbing(kd, kd_progdi, kd_tapel, kd_smt, ".
