...
if ($_POST['btnHPS'])
	...
	for ($i=1; $i<=$jml;$i++)
		...
		//NULL-kan ruang e....
		mysql_query("UPDATE mahasiswa_kelas SET kd = '$smtkd', ".
				"kd_ruang = '' ".
...
if ($_POST['btnSMPx'])
	...
	if ($tc != 0)
		...
		{
		//query
		mysql_query("UPDATE mahasiswa_kelas SET kd_ruang = '$rukd' ".
...
if ($_POST['btnSMP2'])
	...
	for($i=1;$i<=$total;$i++)
		...
		//query
		mysql_query("UPDATE mahasiswa_kelas SET no_absen = '$absx' ".
